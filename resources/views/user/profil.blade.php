    ...
    <section class="page-section mt-5" id="portfolio">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Profil User</h2>
                <h3 class="section-subheading text-muted">Informasi pribadi dan detail akun Anda</h3>
            </div>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-info" role="tabpanel">
                            <form action="{{ route('user.updateProfile') }}" method="POST">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary bg-primary text-white">Simpan
                                        Perubahan</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="tab-pane fade" id="pills-security" role="tabpanel">
                            <form action="{{ route('user.updatePassword') }}" method="POST">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <button type="button" class="btn btn-outline-primary me-md-2">Batal</button>
                                    <button type="submit" class="btn btn-outline-primary bg-primary text-white">Perbaharui
                                        Password</button>
                                </div>
                            </form>
                        </div>
